...
# TODO(carrier): point this at the carrier's own site.
CONFIGURATION_URL = "https://example-carrier.test"

ATTRIBUTION = "Data provided by Example Carrier"
...
def build_device_info(entry: ConfigEntry) -> DeviceInfo:
    ...
    "Example Carrier (you@example.com) Incoming parcels".
    """
    return DeviceInfo(
        identifiers={(DOMAIN, entry.entry_id)},
        name=f"Example Carrier ({entry.title})",
