...
TRACKING_API_URL = "https://api.example-carrier.test/v1/track/{tracking_code}"
...
#
# TODO(carrier): if the carrier issues a client_id/client_secret pair instead
# of a single key (an OAuth client-credentials flow), add a second constant
# here and a second field in config_flow.py rather than overloading this one.
