"""Tests for the Example Carrier deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.example_carrier.calendar import ExampleCarrierDeliveriesCalendar
...
def _cal(data):
    return ExampleCarrierDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="Example Carrier Shop")])
    assert cal._events()[0].location == "Example Carrier Shop"
